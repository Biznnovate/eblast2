...
angular.module('app', ['ionic', 'pouchdb', 'chart.js', 'xeditable', 'ngcsv', 'ngSanitize', 'ngCsv', 'ngCsvImport', 'app.controllers', 'app.routes',
    ...
    'app.reporteCarga1', 'app.subirProyecto', 'app.vistaDeProyecto', 'app.adminConductor', 'angularjs-input-file', 'naif.base64', 'pdf', 'app.dataCamion', 'app.tomaDeMuestra', 'app.login', 'app.reporteCamion', 'app.vistaPreviaMuestra',
])
